/**
 * Deterministic sin/cos (Docs/02 §4): polynomial minimax approximation with
 * pure arithmetic — identical results on every JS engine, unlike Math.sin.
 * Accuracy ~1e-6 over the full range after reduction; plenty for movement.
 */
...
/**
 * Deterministic atan (minimax, ~2e-6) and atan2. Used by bots to derive a
 * facing yaw from a direction vector.
 */
